...
## Frente 2: prototipagem do 4G com ns-3
   ...
   ### **Atividade 2.4**: Entender, simular e plotar um cenário LTE + EPC [Hands-on](https://nbviewer.org/github.com/vicentesousa/ns3-intermediate-training/blob/master/LTE/fase_02/HD_04/f01_hd04.ipynb) - [link](https://github.com/vicentesousa/ns3-intermediate-training/blob/master/LTE/fase_02/HD_04/f01_hd04.ipynb)
      **Objetivos**:

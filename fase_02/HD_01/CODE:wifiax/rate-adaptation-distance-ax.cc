...
int main (int argc, char *argv[])
{
  ...
  std::string staManager = "ns3::IdealWifiManager";
  std::string apManager = "ns3::IdealWifiManager";
  std::string standard = "802.11ax-5GHz";
  std::string outputFileName = "ideal_manager_5GHz_3200ns";
  uint32_t BE_MaxAmpduSize = 65535;
  uint32_t guardInterval = 3200;
  ...
  if (standard == "802.11a" || standard == "802.11b" || standard == "802.11g")
    ...
    else if (standard == "802.11ax-2.4GHz")
   {

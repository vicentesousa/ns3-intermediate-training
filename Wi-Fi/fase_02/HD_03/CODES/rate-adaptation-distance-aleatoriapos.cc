...
static ns3::GlobalValue g_algoritmo ("algoritmoG",
							 "algortimo de adptação de taxa",
...
static ns3::GlobalValue g_rated ("ratedG",
							 "Offered data Rate",
               				 ns3::StringValue ("1.5Mbps"),
               				 ns3::MakeStringChecker());

static ns3::GlobalValue g_rateu ("rateuG",
							 "Offered data Rate",
               				 ns3::StringValue ("0.75Mbps"),
               				 ns3::MakeStringChecker());
...
int main (int argc, char *argv[])
{
  ...
  // new parameters
  GlobalValue::GetValueByName ("algoritmoG", stringValue);
  ...
  GlobalValue::GetValueByName ("ratedG", stringValue);
  std::string rated = stringValue.Get ();
  GlobalValue::GetValueByName ("rateuG", stringValue);
  std::string rateu = stringValue.Get ();
...
for (iteripv4 = ista.Begin(); iteripv4 < ista.End(); iteripv4++){
        ...
        onoff.SetConstantRate (DataRate (rated), 1420);
  ...
  onoff1.SetConstantRate (DataRate (rateu), 1420);
...
//dl_results = "DL_Results_TESTE1_.txt";
//ul_results = "UL_Results_TESTE1_.txt";

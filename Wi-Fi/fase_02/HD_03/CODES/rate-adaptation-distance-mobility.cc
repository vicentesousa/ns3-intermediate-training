...
int main (int argc, char *argv[])
  ...
  //std::string apManager = "ns3::ConstantRateWifiManager";
  //std::string staManager = "ns3::ConstantRateWifiManager";
  ...
  mobility.SetMobilityModel ("ns3::RandomWalk2dMobilityModel",
		  	  	  	  	  	 "Speed", StringValue("ns3::UniformRandomVariable[Min=40.0|Max=45.0]"),
...
//std::string managertxt = std::to_string(staManager);

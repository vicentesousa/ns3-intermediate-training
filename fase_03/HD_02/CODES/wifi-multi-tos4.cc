...
//	wifi.SetRemoteStationManager("ns3::MinstrelHtWifiManager");
	...
	Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/BE_Txop/Aifsn", UintegerValue (3));
	...
	Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/BK_Txop/Aifsn", UintegerValue (7));
	Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/BK_Txop/TxopLimit", TimeValue (MicroSeconds (0)));
	// VI_Txop
	Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/VI_Txop/MinCw", UintegerValue (7));
	Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/VI_Txop/MaxCw", UintegerValue (15));
	Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/VI_Txop/Aifsn", UintegerValue (2));
	Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/VI_Txop/TxopLimit", TimeValue (MicroSeconds (3008)));
	// VO_Txop
	Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/VO_Txop/MinCw", UintegerValue (3));
	Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/VO_Txop/MaxCw", UintegerValue (7));
	Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/VO_Txop/Aifsn", UintegerValue (2));
	Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/VO_Txop/TxopLimit", TimeValue (MicroSeconds (1504)));
	...
	if (uplinkstatus == false){
		BE_results = "DL_Results_BE_edca_" + nstastxt + ".txt";
		BK_results = "DL_Results_BK_edca_" + nstastxt + ".txt";
		VI_results = "DL_Results_VI_edca_" + nstastxt + ".txt";
		VO_results = "DL_Results_VO_edca_" + nstastxt + ".txt";
	}
	if (uplinkstatus == true){
		BE_results = "UL_Results_BE_edca_" + nstastxt + ".txt";
		BK_results = "UL_Results_BK_edca_" + nstastxt + ".txt";
		VI_results = "UL_Results_VI_edca_" + nstastxt + ".txt";
		VO_results = "UL_Results_VO_edca_" + nstastxt + ".txt";
	}
...
//		if (uplinkstatus == true){
		for (int k = 5000; k < (5000+nWifi*4); k = k + 4){
